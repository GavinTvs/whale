...
import kotlinx.android.synthetic.main.fragment_tab_iii.*


/**
 * TabFragment
 */
@Route(path = FragmentPath.TAB_III)
class TabIIIFragment : BaseFragment() {
    ...
    override fun initFragmentViewId(): Int {
        return R.layout.fragment_tab_iii
    }
